...
exports.main = async (event, context) => {
  try {
    ...
    console.log(openid);
    if (openid === 'ovNNR3SZ37HlQkLiAkY8ztAyznWU') {//_openidA放到单引号里
        openid = 'ovNNR3dUcfHFNOsO1M0gTtjK2zsg';//_openidB放到单引号
    } else {
        openid = 'ovNNR3SZ37HlQkLiAkY8ztAyznWU';//_openidA放到单引号里
    }
